      ...
      <section id="works" className={translateWorks ? 'translate-up' : ''}>
        ...
        <div className='section-content'>
          ...
          <nav className={`posts-navigation ${!hasNextPost ? 'no-next' : ''}`}>
            {hasNextPost && (
              <button onClick={() => onSelectWork(currentData.next_post.slug)} className="prev-post">
            ...
            {hasPrevPost && (
              <button onClick={() => onSelectWork(currentData.previous_post.slug)} className="next-post">
